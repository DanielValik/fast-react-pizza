      ...
      <Form method="POST">
        ...
        <div className="mb-5 flex gap-2 sm:flex-row sm:items-center">
          ...
          <div className="grow">
            ...
            {formErrors?.phone && (
              <p className="bg mt-2 rounded-md bg-red-100 p-2 text-xs text-red-700">
                {formErrors.phone}
              </p>
            )}
          </div>
        ...
        <div className="mb-5 flex gap-2 sm:flex-row sm:items-center">
          ...
          {!position.latitude && !position.longitude && (
            <span className="absolute z-50 sm:right-[21px] md:right-[25px] lg:right-[150px] xl:right-[360px]">
              <Button
                type="small"
                disabled={isLoadingAdress}
                onClick={(e) => {
...
export async function action({ request }) {
  ...
  //Handling possible form errrors
  const errors = {};
  ...
  //If all data is completed create order and redirect to page with placed order
